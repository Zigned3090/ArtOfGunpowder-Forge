...
@OnlyIn(Dist.CLIENT)
public class RenderLvl2TntEntity extends EntityRenderer<Lvl2TntEntity> {
    public RenderLvl2TntEntity(EntityRendererProvider.Context p_174426_) {
        super(p_174426_);
        this.shadowRadius = 0.5F;
    }

    public void render(Lvl2TntEntity lvl2TntEntity, float p_116178_, float p_116179_, PoseStack p_116180_, MultiBufferSource p_116181_, int p_116182_) {
        p_116180_.pushPose();
        ...
        p_116180_.popPose();
        super.render(lvl2TntEntity, p_116178_, p_116179_, p_116180_, p_116181_, p_116182_);
    }

    @Override
    public ResourceLocation getTextureLocation(Lvl2TntEntity lvl2TntEntity) {
