...
public class RenderLvl2DetonatorEntity extends EntityRenderer<Lvl2DetonatorEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModMain.MODID ,"textures/entity/projectile/lvl_2_detonator.png");
    private static final float MIN_CAMERA_DISTANCE_SQUARED = 12.25F;
    private final ItemRenderer itemRenderer;
    private final float scale;
    private final boolean fullBright;

    public RenderLvl2DetonatorEntity(EntityRendererProvider.Context manager) {
        super(manager);
    ...
    public boolean shouldRender(Lvl2DetonatorEntity p_114491_, Frustum p_114492_, double p_114493_, double p_114494_, double p_114495_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(Lvl2DetonatorEntity p_110775_1_) {
        return TEXTURE;
    }

    public void render(Lvl2DetonatorEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStackIn, MultiBufferSource bufferIn, int packedLightIn) {
