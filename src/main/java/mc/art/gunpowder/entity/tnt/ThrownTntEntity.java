...
public class ThrownTntEntity extends ThrowableItemProjectile {
    ...
    public ThrownTntEntity(EntityType<? extends ThrownTntEntity> p_32076_, Level p_32077_) {
        super(p_32076_, p_32077_);
        this.blocksBuilding = true;
    }

    public ThrownTntEntity(Level p_37481_, LivingEntity p_37482_) {
        super(ModEntityType.DETONATOR_ENTITY.get(), p_37482_, p_37481_);
    }

    public ThrownTntEntity(Level p_32079_, double p_32080_, double p_32081_, double p_32082_, @Nullable LivingEntity p_32083_) {
        this(ModEntityType.THROWN_TNT_ENTITY.get(), p_32079_);
    ...
    protected Item getDefaultItem() {
        return ItemListener.GUNPOWDER_STICK_ITEM.get();
    }
