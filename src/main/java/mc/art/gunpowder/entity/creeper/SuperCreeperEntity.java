...
public class SuperCreeperEntity extends Monster {
    ...
    public SuperCreeperEntity(EntityType<? extends SuperCreeperEntity> p_32278_, Level p_32279_) {
        super(p_32278_, p_32279_);
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(1, new FloatGoal(this));
        this.goalSelector.addGoal(2, new SuperCreeperSwellGoal(this));
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, 0.25D).add(Attributes.MAX_HEALTH, 70.0F);
    }
    ...
    private void explodeCreeper() {
        if (!this.level.isClientSide) {
            ...
            this.dead = true;
            this.level.explode(this, this.getX(), this.getY(), this.getZ(), 24.0F, Explosion.BlockInteraction.BREAK);
            this.discard();
