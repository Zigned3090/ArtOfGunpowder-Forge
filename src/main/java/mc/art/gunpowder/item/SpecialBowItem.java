...
public class SpecialBowItem extends ProjectileWeaponItem {
    public static final int MAX_DRAW_DURATION = 20;
    public static final int DEFAULT_RANGE = 15;

    public SpecialBowItem(Item.Properties p_40660_) {
        super(p_40660_);
    }
        ...
        if (p_40669_ instanceof Player) {
            ...
            if (!itemstack.isEmpty() || flag) {
                if (itemstack.isEmpty()) {
                    itemstack = new ItemStack(ItemListener.EXPLODE_ARROW_ITEM.get());
                }
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!p_40668_.isClientSide) {
                        ExplodeArrowItem explodeArrowItem = (ExplodeArrowItem)(itemstack.getItem() instanceof ExplodeArrowItem ? itemstack.getItem() : ItemListener.EXPLODE_ARROW_ITEM.get());
                        AbstractArrow abstractarrow = explodeArrowItem.createArrow(p_40668_, itemstack, player);
                        ...
                        if (flag1 || player.getAbilities().instabuild && (itemstack.is(ItemListener.EXPLODE_ARROW_ITEM.get()))) {
    ...
    public Predicate<ItemStack> getAllSupportedProjectiles() {
        return itemStack -> itemStack.is(ItemListener.EXPLODE_ARROW_ITEM.get());
    }
